...
import autoInjection.com.word.service.WordRegisterService;
import autoInjection.com.word.service.WordSearchService;
...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		GenericXmlApplicationContext ctx = 
				new GenericXmlApplicationContext("classpath:autoInjection/appCtx.xml");
