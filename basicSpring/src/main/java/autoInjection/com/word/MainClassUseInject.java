package autoInjection.com.word;

import org.springframework.context.support.GenericXmlApplicationContext;

import autoInjection.com.word.service.WordRegisterServiceUseAutowired;
import autoInjection.com.word.service.WordRegisterServiceUseInject;
import autoInjection.com.word.service.WordSearchServiceUseAutowired;
import autoInjection.com.word.service.WordSearchServiceUseInject;
...
public class MainClassUseInject {
	...
	public static void main(String[] args) {
		...
		GenericXmlApplicationContext ctx = 
				new GenericXmlApplicationContext("classpath:autoInjection/appCtxUseInject.xml");
