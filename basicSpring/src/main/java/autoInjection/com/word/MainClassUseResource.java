...
import autoInjection.com.word.service.WordRegisterServiceUseResource;
import autoInjection.com.word.service.WordSearchServiceUseResource;
...
//				new GenericXmlApplicationContext("classpath:autoInjection/appCtxUseAutowired.xml");
		GenericXmlApplicationContext ctx = 
				new GenericXmlApplicationContext("classpath:autoInjection/appCtxUseResource.xml");
