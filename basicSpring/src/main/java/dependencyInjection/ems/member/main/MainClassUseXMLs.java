package dependencyInjection.ems.member.main;
...
import dependencyInjection.ems.member.service.EMSInformationService;
import dependencyInjection.ems.member.service.StudentAllSelectService;
import dependencyInjection.ems.member.service.StudentModifyService;
import dependencyInjection.ems.member.service.StudentRegisterService;
import dependencyInjection.ems.member.service.StudentSelectService;
...
//		StudentAssembler assembler = new StudentAssembler();
		// xml파일이 분리되었기에 분리된 3개 설정파일을 배열에 다 넣어줌(스프링 컨테이너 생성)
		// 자주 사용하는 방법
		String[] appCtxs = {"classpath:dependencyInjection/appDaoService.xml", "classpath:dependencyInjection/appDatabase.xml", "classpath:dependencyInjection/appInformation.xml"};
